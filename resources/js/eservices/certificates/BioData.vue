            ...
            <div class="form-group row">
                ...
                <div class="col-sm-4">
                    <div class="form-check">
                        <i class="mr-1" :class="appointment.patient.sex == 'Male' ? 'fa fa-check' : 'far fa-square'"></i>
                ...
                <div class="col-sm-4">
                    <div class="form-check">
                        <i class="mr-1" :class="appointment.patient.sex == 'Female' ? 'fa fa-check' : 'far fa-square'"></i>
