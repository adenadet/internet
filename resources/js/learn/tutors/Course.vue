                ...
                <div class="col-12 col-md-12 col-lg-12 order-2 order-md-1">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="text-muted"><p class="text-sm">Category: <b class="d-block">{{course.category.name}}</b></p><p class="text-sm">Sub Category: <b class="d-block">{{course.sub_category.name}}</b></p>
                            </div>
                        </div>
                    </div>
                    <div class="row">
