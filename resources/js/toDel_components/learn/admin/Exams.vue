                    ...
                    <table class="table table-hover table-head-fixed">
                        ...
                        <tbody>
                            <tr v-for="exam in exams.data" :key="exam.id">
                                ...
                                <td>
                                    <router-link :to="'/learn/admin_area/exam/'+exam.id"><button title="View Sub Categories" class="btn btn-sm btn-success"><i class="fa fa-eye"></i></button></router-link>
...
export default {
    ...
    methods:{
        ...
        getAllInitials(){
            ...
            .catch(()=>{
                this.$Progress.fail();
                toast.fire({icon: 'error', title: 'Exams not loaded successfully',})
            });
        },
        getExam(page=1){
