        ...
        <alert-error :form="ExamData"></alert-error> 
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12">
                    <div class="form-group">
                        <label>Course</label>
                        <select class="form-control" id="course_id" name="course_id" placeholder="Enter Street Desc" v-model="ExamData.course_id" :class="{'is-invalid' : ExamData.errors.has('course_id') }" @change="changeLesson">
...
export default {    
    ...
    methods:{
        ...
        changeLesson(){
            this.prev_cat = false;
            this.ExamData.lesson_id = '';
            this.lessons = this.courses[this.ExamData.course_id].lessons;
        },
        createLessons(){
            this.$Progress.start();
