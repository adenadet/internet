             ...
             <div class="col-md-12">
                ...
                <div class="col-md-12">
                    <div class="attachment-holder animated fadeIn" v-cloak v-for="(attachment, index) in attachments" :key="index"> 
                        ...
                        <span class="" style="background: red; cursor: pointer;" @click="removeAttachment(attachment)"><button class="btn btn-xs btn-danger"><i class="fa fa-trash"></i></button></span>
                    </div>
                </div>
             </div>
             <br><br>
    ...
    export default {
        ...
        methods: {
            ...
            submit() {
                ...
                axios.post('api/lms/lessons', this.data, config)
