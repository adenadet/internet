...
<section class="content">
    <div class="row">
        @if (($page_title == 'E-Services | Administrator') || ($page_title == 'E-Services | Front Admin') || ($page_title == 'E-Services | Front Office') || ($page_title == 'E-Services | Medical Officer') || ($page_title == 'E-Services | Radiologist'))
        <div class="col-md-3">
